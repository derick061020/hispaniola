// [vendor] AlignUI — copiado de la DOCUMENTACIÓN PÚBLICA (alignui.com/docs/v1.2/ui/breadcrumb,
// 2026-07-16, PLAN-ALIGNUI.md): los templates Pro locales no traen breadcrumb.tsx.
// Únicos cambios: rutas de import + import type (verbatimModuleSyntax). NO editar
// a mano — personalizar via className (cerebro synexia-health).
