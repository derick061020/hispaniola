// [vendor] AlignUI Pro — copiado de Synexia/referencia-alignui/finance (2026-07-22, PLAN-ALIGNUI.md).
// Únicos cambios: rutas de import y el 'use client' (este build no es Next).
// NO editar a mano — personalizar via className/wrappers
