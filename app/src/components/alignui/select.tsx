...
// Únicos cambios: rutas de import + port de sintaxis Tailwind v3→v4 en 3 clases
// (min-w-[--var]→min-w-(--var), max-h-[--var]→max-h-(--var), !w-1→w-1! — v4 cambió
// el shorthand de custom properties y movió el important al final). NO editar a mano
// — personalizar via className/wrappers (cerebro synexia-health: «override sin tocar el vendor»).
...
import { cnExt } from '@/lib/alignui/cn';
import type { PolymorphicComponentProps } from '@/lib/alignui/polymorphic';
import { tv, type VariantProps } from '@/lib/alignui/tv';
