...
export function ReelsSociales({
  ...
  // instalaciones.
  titulo = 'This is what your day in the Caribbean looks like',
  ...
  eyebrow = 'On video',
  lead = 'Real moments, real people, real Caribbean. Take a look at what a day on board with us is really like.',
  variante = 'seccion',
